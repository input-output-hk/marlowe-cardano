  ...
  declareNamedSchema _ =
    do
      ...
      pure
        ...
        & properties .~ [
                          errorSchema, detailSchema, fatalSchema
                        , roleNameSchema, currencySymbolSchema, tokenNameSchema, tokenSchema
                        , accountIdSchema, choiceIdSchema, valueIdSchema
                        , bytesSchema, transactionSchema, costSchema
                        , messageSchema, warningSchema, hashSchema, addressSchema
                        ]
  ...
  declareNamedSchema _ =
    do
      ...
      pure
        ...
        & oneOf ?~ fmap Inline [nonPositiveDepositSchema, nonPositivePaySchema, partialPaySchema, shadowingSchema, assertionSchema]
