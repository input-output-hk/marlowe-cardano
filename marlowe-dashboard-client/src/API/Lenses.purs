...
_cicCurrentState = _ContractInstanceClientState <<< prop (Proxy :: _ "cicCurrentState")

_cicDefinition :: Lens' (ContractInstanceClientState MarloweContract) MarloweContract
_cicDefinition = _ContractInstanceClientState <<< prop (Proxy :: _ "cicDefinition")
...
_observableState = _PartiallyDecodedResponse <<< prop (Proxy :: _ "observableState")
...
_endpointDescriptionString = _EndpointDescription <<< prop (Proxy :: _ "getEndpointDescription")
