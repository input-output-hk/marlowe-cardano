...
activateContract contractActivationArgs = doPostRequest "/api/contract/activate"
  contractActivationArgs
...
deactivateContract
  ...
  => ContractInstanceId
  -> m Unit
deactivateContract contractInstanceId = doPutRequest $ "/api/contract/instance/"
  <> toUrlPiece contractInstanceId
  <> "/stop"
...
getContractInstanceClientState contractInstanceId = doGetRequest $
  "/api/contract/instance/" <> toUrlPiece contractInstanceId <> "/status"
...
invokeEndpoint
  ...
  -> d
  -> m Unit
invokeEndpoint contractInstanceId endpoint payload = doPostRequest
  ( "/api/contract/instance/" <> toUrlPiece contractInstanceId <> "/endpoint/"
      <> endpoint
  )
  payload
...
getWalletContractInstances wallet = doGetRequest $
  "/api/contract/instances/wallet/" <> toUrlPiece wallet
