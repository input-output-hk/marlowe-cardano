...
instance encodeJsonConnectionError :: EncodeJson ConnectionError where
  encodeJson = defer \_ -> case _ of
    ...
    NoDatum a b -> E.encodeTagged "NoDatum" (a /\ b)
      (E.tuple (E.value >/\< E.value))
...
instance decodeJsonConnectionError :: DecodeJson ConnectionError where
  decodeJson = defer \_ -> D.decode
    ...
    $ Map.fromFoldable
        [ "WrongValidatorAddress" /\ D.content
            (D.tuple $ WrongValidatorAddress </$\> D.value </*\> D.value)
...
_WrongValidatorAddress = prism' (\{ a, b } -> (WrongValidatorAddress a b))
  case _ of
