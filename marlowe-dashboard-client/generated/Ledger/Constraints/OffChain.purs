...
instance encodeJsonMkTxError :: EncodeJson MkTxError where
  encodeJson = defer \_ -> case _ of
    ...
    OwnPubKeyMissing -> encodeJson
      { tag: "OwnPubKeyMissing", contents: jsonNull }
    TypedValidatorMissing -> encodeJson
      { tag: "TypedValidatorMissing", contents: jsonNull }
    DatumWrongHash a b -> E.encodeTagged "DatumWrongHash" (a /\ b)
...
instance decodeJsonMkTxError :: DecodeJson MkTxError where
  decodeJson = defer \_ -> D.decode
    ...
    $ Map.fromFoldable
        ...
        , "MintingPolicyNotFound" /\ D.content
            (MintingPolicyNotFound <$> D.value)
        , "ValidatorHashNotFound" /\ D.content
            (ValidatorHashNotFound <$> D.value)
        , "OwnPubKeyMissing" /\ pure OwnPubKeyMissing
        , "TypedValidatorMissing" /\ pure TypedValidatorMissing
        , "DatumWrongHash" /\ D.content
            (D.tuple $ DatumWrongHash </$\> D.value </*\> D.value)
