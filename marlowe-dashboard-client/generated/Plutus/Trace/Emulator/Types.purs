...
instance encodeJsonContractInstanceMsg :: EncodeJson ContractInstanceMsg where
  encodeJson = defer \_ -> case _ of
    ...
    ReceiveEndpointCall a b -> E.encodeTagged "ReceiveEndpointCall" (a /\ b)
      (E.tuple (E.value >/\< E.value))
    ReceiveEndpointCallSuccess -> encodeJson
      { tag: "ReceiveEndpointCallSuccess", contents: jsonNull }
    ReceiveEndpointCallFailure a -> E.encodeTagged "ReceiveEndpointCallFailure"
      a
      E.value
    NoRequestsHandled -> encodeJson
      { tag: "NoRequestsHandled", contents: jsonNull }
...
instance decodeJsonContractInstanceMsg :: DecodeJson ContractInstanceMsg where
  decodeJson = defer \_ -> D.decode
    ...
    $ Map.fromFoldable
        ...
        , "ReceiveEndpointCall" /\ D.content
            (D.tuple $ ReceiveEndpointCall </$\> D.value </*\> D.value)
        , "ReceiveEndpointCallSuccess" /\ pure ReceiveEndpointCallSuccess
        , "ReceiveEndpointCallFailure" /\ D.content
            (ReceiveEndpointCallFailure <$> D.value)
...
_ReceiveEndpointCallSuccess = prism' (const ReceiveEndpointCallSuccess)
  case _ of
...
instance encodeJsonEmulatorRuntimeError :: EncodeJson EmulatorRuntimeError where
  encodeJson = defer \_ -> case _ of
    ...
    EmulatorJSONDecodingError a b -> E.encodeTagged "EmulatorJSONDecodingError"
      (a /\ b)
      (E.tuple (E.value >/\< E.value))
...
instance decodeJsonEmulatorRuntimeError :: DecodeJson EmulatorRuntimeError where
  decodeJson = defer \_ -> D.decode
    ...
    $ Map.fromFoldable
        ...
        , "EmulatorJSONDecodingError" /\ D.content
            (D.tuple $ EmulatorJSONDecodingError </$\> D.value </*\> D.value)
