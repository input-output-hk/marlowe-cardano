...
data ContractError
  ...
  | EndpointDecodeContractError
      ...
      , eeEndpointValue :: EndpointValue Json
...
instance EncodeJson ContractError where
  encodeJson = defer \_ -> case _ of
    ...
    ChainIndexContractError a b -> E.encodeTagged "ChainIndexContractError"
      (a /\ b)
      (E.tuple (E.value >/\< E.value))
    EmulatorAssertionContractError a -> E.encodeTagged
      "EmulatorAssertionContractError"
      a
      E.value
    ConstraintResolutionContractError a -> E.encodeTagged
      "ConstraintResolutionContractError"
      a
      E.value
    ResumableContractError a -> E.encodeTagged "ResumableContractError" a
      E.value
    CCheckpointContractError a -> E.encodeTagged "CCheckpointContractError" a
      E.value
    EndpointDecodeContractError
      { eeEndpointDescription, eeEndpointValue, eeErrorMessage } -> encodeJson
...
instance DecodeJson ContractError where
  decodeJson = defer \_ -> D.decode
    ...
    $ Map.fromFoldable
        ...
        , "ChainIndexContractError" /\ D.content
            (D.tuple $ ChainIndexContractError </$\> D.value </*\> D.value)
        , "EmulatorAssertionContractError" /\ D.content
            (EmulatorAssertionContractError <$> D.value)
        , "ConstraintResolutionContractError" /\ D.content
            (ConstraintResolutionContractError <$> D.value)
        , "ResumableContractError" /\ D.content
            (ResumableContractError <$> D.value)
        , "CCheckpointContractError" /\ D.content
            (CCheckpointContractError <$> D.value)
        , "EndpointDecodeContractError" /\
            ( EndpointDecodeContractError <$> D.object
                "EndpointDecodeContractError"
                { eeEndpointDescription: D.value :: _ EndpointDescription
                , eeEndpointValue: D.value :: _ (EndpointValue Json)
...
_EmulatorAssertionContractError = prism' EmulatorAssertionContractError
  case _ of
    (EmulatorAssertionContractError a) -> Just a
    _ -> Nothing

_ConstraintResolutionContractError :: Prism' ContractError MkTxError
_ConstraintResolutionContractError = prism' ConstraintResolutionContractError
  case _ of
