...
instance decodeJsonRollbackState ::
  ...
  decodeJson = defer \_ -> D.decode
    ...
    $ Map.fromFoldable
        ...
        , "TentativelyConfirmed" /\ D.content
            ( D.tuple $ TentativelyConfirmed </$\> D.value </*\> D.value </*\>
                D.value
            )
        , "Committed" /\ D.content
...
_TentativelyConfirmed
  :: forall a. Prism' (RollbackState a) { a :: Depth, b :: TxValidity, c :: a }
_TentativelyConfirmed = prism' (\{ a, b, c } -> (TentativelyConfirmed a b c))
  case _ of
