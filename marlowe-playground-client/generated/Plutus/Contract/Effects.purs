...
instance encodeJsonPABReq :: EncodeJson PABReq where
  encodeJson = defer \_ -> case _ of
    ...
    AwaitTxStatusChangeReq a -> E.encodeTagged "AwaitTxStatusChangeReq" a
      E.value
    AwaitTxOutStatusChangeReq a -> E.encodeTagged "AwaitTxOutStatusChangeReq" a
      E.value
    ...
    PosixTimeRangeToContainedSlotRangeReq a -> E.encodeTagged
...
instance decodeJsonPABReq :: DecodeJson PABReq where
  decodeJson = defer \_ -> D.decode
    ...
    $ Map.fromFoldable
        ...
        , "AwaitTxStatusChangeReq" /\ D.content
            (AwaitTxStatusChangeReq <$> D.value)
        , "AwaitTxOutStatusChangeReq" /\ D.content
        ...
        , "WriteBalancedTxReq" /\ D.content
            (WriteBalancedTxReq <$> (D.either D.value D.value))
...
_PosixTimeRangeToContainedSlotRangeReq = prism'
  PosixTimeRangeToContainedSlotRangeReq
  case _ of
...
instance encodeJsonPABResp :: EncodeJson PABResp where
  encodeJson = defer \_ -> case _ of
    ...
    AwaitTxStatusChangeResp a b -> E.encodeTagged "AwaitTxStatusChangeResp"
      (a /\ b)
      (E.tuple (E.value >/\< E.value))
    AwaitTxOutStatusChangeResp a b -> E.encodeTagged
    ...
    ExposeEndpointResp a b -> E.encodeTagged "ExposeEndpointResp" (a /\ b)
      (E.tuple (E.value >/\< E.value))
    PosixTimeRangeToContainedSlotRangeResp a -> E.encodeTagged
      "PosixTimeRangeToContainedSlotRangeResp"
      a
      (E.either E.value E.value)
...
instance decodeJsonPABResp :: DecodeJson PABResp where
  decodeJson = defer \_ -> D.decode
    ...
    $ Map.fromFoldable
        ...
        , "AwaitUtxoProducedResp" /\ D.content
            (AwaitUtxoProducedResp <$> D.value)
        , "AwaitTxStatusChangeResp" /\ D.content
            (D.tuple $ AwaitTxStatusChangeResp </$\> D.value </*\> D.value)
        , "AwaitTxOutStatusChangeResp" /\ D.content
        ...
        , "ExposeEndpointResp" /\ D.content
            (D.tuple $ ExposeEndpointResp </$\> D.value </*\> D.value)
        , "PosixTimeRangeToContainedSlotRangeResp" /\ D.content
            ( PosixTimeRangeToContainedSlotRangeResp <$>
...
_AwaitTxStatusChangeResp :: Prism' PABResp
...
_AwaitTxOutStatusChangeResp :: Prism' PABResp
...
_PosixTimeRangeToContainedSlotRangeResp :: Prism' PABResp
  (Either SlotConversionError (Interval Slot))
...
instance decodeJsonWriteBalancedTxResponse :: DecodeJson WriteBalancedTxResponse where
  decodeJson = defer \_ -> D.decode
    ...
    $ Map.fromFoldable
        [ "WriteBalancedTxFailed" /\ D.content
            (WriteBalancedTxFailed <$> D.value)
        , "WriteBalancedTxSuccess" /\ D.content
