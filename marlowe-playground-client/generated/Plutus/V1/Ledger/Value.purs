...
instance decodeJsonValue :: DecodeJson Value where
  decodeJson = defer \_ -> D.decode $
    ( Value <$> D.record "Value"
        { getValue: D.value :: _ (Map CurrencySymbol (Map TokenName BigInt)) }
    )
...
instance decodeJsonCurrencySymbol :: DecodeJson CurrencySymbol where
  decodeJson = defer \_ -> D.decode $
    ( CurrencySymbol <$> D.record "CurrencySymbol"
        { unCurrencySymbol: D.value :: _ String }
    )
...
instance decodeJsonTokenName :: DecodeJson TokenName where
  decodeJson = defer \_ -> D.decode $
    (TokenName <$> D.record "TokenName" { unTokenName: D.value :: _ String })
