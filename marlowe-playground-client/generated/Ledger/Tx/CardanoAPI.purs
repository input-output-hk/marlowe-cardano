...
instance encodeJsonToCardanoError :: EncodeJson ToCardanoError where
  encodeJson = defer \_ -> case _ of
    ...
    DeserialisationError -> encodeJson
      { tag: "DeserialisationError", contents: jsonNull }
    InvalidValidityRange -> encodeJson
      { tag: "InvalidValidityRange", contents: jsonNull }
    ValueNotPureAda -> encodeJson { tag: "ValueNotPureAda", contents: jsonNull }
    OutputHasZeroAda -> encodeJson
      { tag: "OutputHasZeroAda", contents: jsonNull }
    StakingPointersNotSupported -> encodeJson
      { tag: "StakingPointersNotSupported", contents: jsonNull }
    SimpleScriptsNotSupportedToCardano -> encodeJson
      { tag: "SimpleScriptsNotSupportedToCardano", contents: jsonNull }
    MissingTxInType -> encodeJson { tag: "MissingTxInType", contents: jsonNull }
    MissingMintingPolicyRedeemer -> encodeJson
      { tag: "MissingMintingPolicyRedeemer", contents: jsonNull }
    MissingMintingPolicy -> encodeJson
...
instance decodeJsonToCardanoError :: DecodeJson ToCardanoError where
  decodeJson = defer \_ -> D.decode
    ...
    $ Map.fromFoldable
        ...
        , "SimpleScriptsNotSupportedToCardano" /\ pure
            SimpleScriptsNotSupportedToCardano
...
_StakingPointersNotSupported = prism' (const StakingPointersNotSupported)
  case _ of
    StakingPointersNotSupported -> Just unit
    _ -> Nothing

_SimpleScriptsNotSupportedToCardano :: Prism' ToCardanoError Unit
_SimpleScriptsNotSupportedToCardano = prism'
  (const SimpleScriptsNotSupportedToCardano)
  case _ of
...
_MissingMintingPolicyRedeemer = prism' (const MissingMintingPolicyRedeemer)
  case _ of
