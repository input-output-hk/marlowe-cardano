...
export const ChoiceId = function (
  choiceName: string,
  choiceOwner: Party
): ChoiceId {
...
type Token = { currency_symbol: string; token_name: string };
...
type Bound = { from: bignumber.BigNumber; to: bignumber.BigNumber };
...
type Payee = { account: AccountId } | { party: Party };
...
type Case = { case: Action; then: Contract };
