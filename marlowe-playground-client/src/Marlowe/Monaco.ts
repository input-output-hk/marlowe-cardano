...
export class MarloweCompletionItemProvider
  implements monaco.languages.CompletionItemProvider
{
  ...
  provideCompletionItems(
    ...
    const contract =
      startOfContract + emptyWordHack + "?monaco_suggestions" + endOfContract;
    ...
    return {
      suggestions: this.suggestionsProvider(
        word.word,
        stripParens,
        contract,
        range,
...
export class MarloweCodeActionProvider
  implements monaco.languages.CodeActionProvider
{
  actionsProvider: (
    uri: monaco.Uri,
    marloweType: Array<monaco.editor.IMarkerData>,
    additionalContext: AdditionalContext
  ) => Array<monaco.languages.CodeAction>;
...
export class MarloweDocumentFormattingEditProvider
