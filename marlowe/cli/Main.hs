...
main = do
    ...
    let marloweValidator = typedValidator defaultMarloweParams
    ...
    let ownPubKey = PubKeyHash "d7604c51452bf9c135d63c686ba306d268fcae8494c877e12c44c657"
    let contract = Close
    let md = MarloweData {
            marloweState = State
