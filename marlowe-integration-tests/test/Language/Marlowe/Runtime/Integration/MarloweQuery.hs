...
txNoToInputDatum MarloweQueryTestData{..} = \case
  ...
  Contract1Step2 -> inputsAppliedInputDatum $ initialFundsDeposited contract1Step1
  Contract1Step3 -> inputsAppliedInputDatum $ gimmeTheMoneyChosen contract1Step2
  Contract1Step4 -> inputsAppliedInputDatum $ notified contract1Step3
  Contract2Step1 -> standardContractDatum contract2
  Contract2Step2 -> inputsAppliedInputDatum $ initialFundsDeposited contract2Step1
  Contract2Step3 -> inputsAppliedInputDatum $ gimmeTheMoneyChosen contract2Step2
  Contract2Step4 -> inputsAppliedInputDatum $ notified contract2Step3
  Contract3Step1 -> standardContractDatum contract3
  Contract3Step2 -> inputsAppliedInputDatum $ initialFundsDeposited contract3Step1
  Contract3Step3 -> inputsAppliedInputDatum $ gimmeTheMoneyChosen contract3Step2
  Contract3Step4 -> inputsAppliedInputDatum $ notified contract3Step3
