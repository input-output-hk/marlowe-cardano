...
let
  ...
  projectPackagesAllHaddock = (haskell-nix.haskellLib.selectProjectPackages projectAllHaddock.hsPkgs) // {
    inherit (projectAllHaddock.hsPkgs) plutus-core plutus-tx plutus-tx-plugin plutus-ledger-api plutus-pab plutus-contract plutus-chain-index-core plutus-chsin-index plutus-ledger;
  };
