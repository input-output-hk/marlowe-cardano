{ system
  ...
  ({
    ...
    src = (pkgs.lib).mkDefault (pkgs.fetchurl {
      url = "https://input-output-hk.github.io/cardano-haskell-packages/package/ouroboros-consensus-shelley-0.1.0.0.tar.gz";
      sha256 = "9b183e9b089607e8a861e4bf4d2aaf9d5ba350a5d87b68648a78a8608332deb0";
      });
    }) // {
