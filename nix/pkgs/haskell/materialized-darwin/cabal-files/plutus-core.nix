{ system
  ...
  ({
    ...
    package = {
      specVersion = "3.0";
      identifier = { name = "plutus-core"; version = "1.0.0.1"; };
      license = "Apache-2.0";
      copyright = "";
    ...
    src = (pkgs.lib).mkDefault (pkgs.fetchurl {
      url = "https://input-output-hk.github.io/cardano-haskell-packages/package/plutus-core-1.0.0.1.tar.gz";
      sha256 = "e0046a1df42a618ed49759ebc0711cba0f6b47e4a06932f214c27b62f719f751";
      });
    }) // {
