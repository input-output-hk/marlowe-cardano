{ system
  ...
  ({
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "typed-protocols-examples"; version = "0.1.0.1"; };
      license = "Apache-2.0";
    ...
    src = (pkgs.lib).mkDefault (pkgs.fetchurl {
      url = "https://input-output-hk.github.io/cardano-haskell-packages/package/typed-protocols-examples-0.1.0.1.tar.gz";
      sha256 = "4a39ee97bc876a1eb0bb0fddea9c197453c69f6cd6c7e2bd83d606142e50933b";
      });
    }) // {
