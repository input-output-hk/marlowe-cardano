{ system
  ...
  ({
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "vector-map"; version = "0.1.1.2"; };
      license = "Apache-2.0";
      copyright = "";
    ...
    src = (pkgs.lib).mkDefault (pkgs.fetchurl {
      url = "https://input-output-hk.github.io/cardano-haskell-packages/package/vector-map-0.1.1.2.tar.gz";
      sha256 = "1bcaf9232b5d87be34e26ad07843be4db79d785364017f537d09d2a8a513279b";
      });
    }) // {
