{ system
  ...
  ({
    ...
    src = (pkgs.lib).mkDefault (pkgs.fetchurl {
      url = "https://input-output-hk.github.io/cardano-haskell-packages/package/Win32-network-0.1.0.0.tar.gz";
      sha256 = "7447a454d5f731dc7e4c955425542b19c75979ed4e77df1fbd8a3789ca8912e4";
      });
    }) // {
