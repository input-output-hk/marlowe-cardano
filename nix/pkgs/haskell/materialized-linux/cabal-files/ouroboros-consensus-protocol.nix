{ system
  ...
  ({
    ...
    src = (pkgs.lib).mkDefault (pkgs.fetchurl {
      url = "https://input-output-hk.github.io/cardano-haskell-packages/package/ouroboros-consensus-protocol-0.1.0.0.tar.gz";
      sha256 = "6af68e4b07d579deefcb1ed3cac9a10dcfb283a93f585fb461b8b9ea84469cbb";
      });
    }) // {
