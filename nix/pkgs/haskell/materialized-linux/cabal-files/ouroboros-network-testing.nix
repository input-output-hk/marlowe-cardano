{ system
  ...
  ({
    ...
    src = (pkgs.lib).mkDefault (pkgs.fetchurl {
      url = "https://input-output-hk.github.io/cardano-haskell-packages/package/ouroboros-network-testing-0.1.0.0.tar.gz";
      sha256 = "64ffce1b2a7ed496dfc73c701d3c310f9285b51766c35cfd3d4d2859be6eb52d";
      });
    }) // {
