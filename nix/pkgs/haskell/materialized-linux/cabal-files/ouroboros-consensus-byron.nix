{ system
  ...
  ({
    ...
    src = (pkgs.lib).mkDefault (pkgs.fetchurl {
      url = "https://input-output-hk.github.io/cardano-haskell-packages/package/ouroboros-consensus-byron-0.1.0.0.tar.gz";
      sha256 = "57244aa62965bf48f02b9ca328d7a877b360639474ff261ec2c65c54b2aae855";
      });
    }) // {
