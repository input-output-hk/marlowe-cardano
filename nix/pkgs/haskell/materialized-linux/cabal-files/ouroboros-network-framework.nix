{ system
  ...
  ({
    ...
    src = (pkgs.lib).mkDefault (pkgs.fetchurl {
      url = "https://input-output-hk.github.io/cardano-haskell-packages/package/ouroboros-network-framework-0.1.0.0.tar.gz";
      sha256 = "a10fdae37fc8ee0d58f06a41bb8701bdf057fb900138b3819c1e6c92d389a45e";
      });
    }) // {
