{ system
  ...
  ({
    ...
    src = (pkgs.lib).mkDefault (pkgs.fetchurl {
      url = "https://input-output-hk.github.io/cardano-haskell-packages/package/network-mux-0.1.0.0.tar.gz";
      sha256 = "ddcf89ad7fca08d2f1b92b850f550ce35f30520f54ae9e7ea327b72146d8ed31";
      });
    }) // {
