  ...
  pkgs = hackage:
    {
      packages = {
        ...
        "postgresql-binary".revision = (((hackage."postgresql-binary")."0.12.4.2").revisions).default;
        ...
        "yesod-core".revision = (((hackage."yesod-core")."1.6.22.0").revisions).default;
        ...
        "postgresql-syntax".revision = (((hackage."postgresql-syntax")."0.4.0.2").revisions).default;
        ...
        "statistics".revision = (((hackage."statistics")."0.16.0.2").revisions).default;
        ...
        "yesod".revision = (((hackage."yesod")."1.6.2").revisions).default;
        ...
        "ghc".flags.dynamic-system-linker = true;
        "ghc".flags.stage2 = false;
        "ghc".flags.integer-simple = false;
        "ghc".flags.terminfo = true;
        "ghc".flags.ghci = false;
        "ghc".flags.stage3 = false;
        "ghc".flags.integer-gmp = false;
        "ghc".flags.stage1 = false;
        ...
        "pretty-simple".revision = (((hackage."pretty-simple")."4.1.0.0").revisions).default;
        ...
        "headed-megaparsec".revision = (((hackage."headed-megaparsec")."0.2.0.1").revisions).default;
        "http-client-tls".revision = (((hackage."http-client-tls")."0.3.6.1").revisions).default;
        "bytebuild".revision = (((hackage."bytebuild")."0.3.10.0").revisions).default;
        ...
        "hspec-discover".revision = (((hackage."hspec-discover")."2.9.6").revisions).default;
        ...
        "hasql-th".revision = (((hackage."hasql-th")."0.4.0.11").revisions).default;
        ...
        "persistent".revision = (((hackage."persistent")."2.13.3.4").revisions).default;
        ...
        "text-builder".revision = (((hackage."text-builder")."0.6.6.5").revisions).default;
        ...
        "contiguous".revision = (((hackage."contiguous")."0.6.1.1").revisions).default;
        ...
        "tasty-hedgehog".revision = (((hackage."tasty-hedgehog")."1.2.0.0").revisions).default;
        ...
        "genvalidity".revision = (((hackage."genvalidity")."1.0.0.1").revisions).default;
        ...
        "hw-aeson".revision = (((hackage."hw-aeson")."0.1.5.0").revisions).default;
        "distributive".revision = (((hackage."distributive")."0.6.2.1").revisions).default;
        "distributive".flags.tagged = true;
        "distributive".flags.semigroups = true;
        "yesod-persistent".revision = (((hackage."yesod-persistent")."1.6.0.7").revisions).default;
        ...
        "libBF".revision = (((hackage."libBF")."0.6.3").revisions).default;
        ...
        "yesod-form".revision = (((hackage."yesod-form")."1.7.0").revisions).default;
        ...
        "sbv".revision = (((hackage."sbv")."8.17").revisions).default;
        ...
        "hasql".revision = (((hackage."hasql")."1.5.0.2").revisions).default;
        ...
        "hspec-core".revision = (((hackage."hspec-core")."2.9.6").revisions).default;
        ...
        "hspec".revision = (((hackage."hspec")."2.9.6").revisions).default;
        ...
        "hkd".revision = (((hackage."hkd")."0.1").revisions).default;
        ...
        "text-builder-dev".revision = (((hackage."text-builder-dev")."0.2.0.1").revisions).default;
        ...
        "shakespeare".revision = (((hackage."shakespeare")."2.0.26").revisions).default;
        ...
        "validity".revision = (((hackage."validity")."0.12.0.0").revisions).default;
    ...
    ({ lib, ... }:
      {
        packages = {
          ...
          "tostring".components.library.planned = lib.mkOverride 900 true;
