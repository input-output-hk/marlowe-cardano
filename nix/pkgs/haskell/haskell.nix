...
let
  ...
  project = haskell-nix.cabalProject' ({ pkgs, ... }: {
    ...
    sha256map = {
      ...
      "https://github.com/input-output-hk/servant-purescript.git"."bc74e3e258764d62c836a0c53d61830ec0de2c79" = "06pfyd9flfwx90mvcqxls65bb6lfrpzxszg33lkbs7dkxf0fdpki";
      ...
      "https://github.com/input-output-hk/plutus-apps"."36eed44347266ac8762d344ba15116013523fe0d" = "03xf08b4bp4ddi889z0vjz5b657m18abz6pk8cnyrz1l67z9lg68";
    };
