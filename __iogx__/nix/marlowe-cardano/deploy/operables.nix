...
let
  ...
  marlowe-chain-indexer = self.packages."marlowe-chain-sync:exe:marlowe-chain-indexer";
  marlowe-chain-sync = self.packages."marlowe-chain-sync:exe:marlowe-chain-sync";
  marlowe-tx = self.packages."marlowe-runtime:exe:marlowe-tx";
  marlowe-proxy = self.packages."marlowe-runtime:exe:marlowe-proxy";
  marlowe-indexer = self.packages."marlowe-runtime:exe:marlowe-indexer";
  marlowe-web-server = self.packages."marlowe-runtime-web:exe:marlowe-web-server";
  marlowe-sync = self.packages."marlowe-runtime:exe:marlowe-sync";
