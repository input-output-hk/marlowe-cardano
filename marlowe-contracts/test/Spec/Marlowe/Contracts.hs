  ...
  let Just contract =
      ...
      txIn =
        [ C.TransactionInput
            ...
            [C.NormalInput $ C.IDeposit w1Pk w1Pk ada 75_000_000]
        , C.TransactionInput
            (toPOSIX "2022-12-31 00:00:00.000000 UTC", toPOSIX "2022-12-31 23:59:59.999999 UTC")
            [C.NormalInput $ C.IDeposit w2Pk w2Pk ada 90_000_000]
        ]
  ...
  let Just contract =
      ...
      txIn =
        [ C.TransactionInput
            ...
            [C.NormalInput $ C.IDeposit w1Pk w1Pk ada 75_000_000]
        , C.TransactionInput
            (toPOSIX "2022-06-30 00:00:00.000000 UTC", toPOSIX "2022-06-30 23:59:59.999999 UTC")
            [C.NormalInput $ C.IDeposit w2Pk w2Pk ada 1_000_000]
        , C.TransactionInput
            (toPOSIX "2022-12-31 00:00:00.000000 UTC", toPOSIX "2022-12-31 23:59:59.999999 UTC")
            [C.NormalInput $ C.IDeposit w2Pk w2Pk ada 1_000_000]
        , C.TransactionInput
  ...
  let Just contract =
      ...
      txIn =
        ...
        , C.TransactionInput
            ...
            [C.NormalInput $ C.IDeposit w1Pk (Role "BondProvider") ada 10_000_000]
        , C.TransactionInput
...
reverseConvertibleTest =
  let Just contract =
      ...
      txIn =
        ...
        , C.TransactionInput
            (exerciseTime, exerciseTime)
            [C.NormalInput $ C.IChoice (ChoiceId "Exercise Put" (Role "OptionCounterparty")) 0]
        ]
   in case C.playTrace 0 contract txIn of
        C.TransactionOutput{..} -> do
          assertClose txOutContract
