Feature: Editing existing contracts
  ...
  Scenario: Editing an existing Haskell contract template
    ...
    When I enter "Haskell Swap Contract Code" in "playground editor"
    And I click the "compile" button

    Then the "Send To Simulator" button should be "enabled"

  Scenario: Editing a saved Haskell contract template
    Given I am on the "home page"
