...
echo "Now the seller $SELLER_NAME can submit a transaction to release funds:"
...
echo "The confirmation of the problem resulted in closing the contract, paying $PRICE lovelace back to the buyer $BUYER_NAME and $MINIMUM_ADA lovelace to the mediator $MEDIATOR_NAME in the transaction "'`'"$TX_4"'`'". There is no UTxO at the contract address:"
