...
[This zero-coupon bond](../../../marlowe-contracts/src/Marlowe/Contracts/ZeroCouponBond.hs) has one party borrow and another pay back with interest. It uses role tokens.
