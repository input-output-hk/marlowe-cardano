...
ISSUE_TIMEOUT=$((NOW+6*HOUR))
MATURITY_TIMEOUT=$((NOW+6*HOUR))
...
cardano-cli query utxo "${MAGIC[@]}" --address "$CONTRACT_ADDRESS" | sed -n -e "1p;2p;/$TX_1/p;/$TX_2/p;/$TX_4/p"
