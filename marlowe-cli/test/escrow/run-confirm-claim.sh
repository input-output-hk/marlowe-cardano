...
marlowe-cli transaction-advance "${MAGIC[@]}"                                 \
                                ...
                                --tx-out "$SELLER_ADDRESS+$ARBITRARY_LOVELACE" \
...
echo
echo "The dismissing the claim resulted in closing the contract, paying $PRICE lovelace to $SELLER_NAME and $MINIMUM_ADA lovelace to $MEDIATOR_NAME in the transaction $TX_5."
