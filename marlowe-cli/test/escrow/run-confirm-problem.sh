...
# Test of an escrow contract. In this case the buyer reports a problem and the seller confirms the problem.
...
echo
echo "The confirmation of the problem resulted in closing the contract, paying $PRICE lovelace back to $BUYER_NAME and $MINIMUM_ADA lovelace to $MEDIATOR_NAME in the transaction $TX_3."
