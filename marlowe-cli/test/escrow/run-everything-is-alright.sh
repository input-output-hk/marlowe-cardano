...
# Test of an escrow contract. In this case the buyer does not report a problem.
...
# Transaction 3. The buyer reports that everything is alright, so funds are released to the seller and mediator, closing the contract.

echo
echo "Transaction 3. The buyer reports that everything is alright, so funds are released to the seller and mediator, closing the contract."
...
echo
echo "The closing of the contract paid $PRICE lovelace to $SELLER_NAME and $MINIMUM_ADA lovelace to $MEDIATOR_NAME in the transaction $TX_3."
