...
instance ToJSON MarloweValidators where
  ...
  toJSON (ReferenceCurrentValidators permanent publisher) =
    Aeson.object
      [ "referenceCurrent" .=
        Aeson.object ["permanent" .= permanent, "publisher" .= publisher]
      ]
...
cliMarloweThreadContractId =
  ...
  Runtime.Api.fromCardanoTxIn . overAnyMarloweThread marloweThreadInitialTxIn
