...
-- | A Marlowe address.
data MarloweAddress
  = -- | The Marlowe application's address.
    ApplicationCredential ScriptHash
  | -- | The Marlowe payout's address.
    PayoutCredential ScriptHash
...
data MarloweEvent
  = -- | Marlowe parameters associated with a minting transaction.
    Parameters
      { meBlock :: BlockHeader
      -- ^ The block header for the Marlowe transaction.
      , meTxId :: TxId
      -- ^ The ID of the Marlowe transaction.
      , meApplicationAddress :: MarloweAddress
      -- ^ The address of the Marlowe application validator.
      , mePayoutAddress :: MarloweAddress
      -- ^ The address of the Marlowe payout validator.
      , meParams :: MarloweParams
      -- ^ The Marlowe validator parameters.
      , meMetadata :: Maybe A.Value
      -- ^ The transaction metadata, if any.
      }
  | -- | A Marlowe transaction.
    Transaction
      ...
      , meOuts :: [MarloweOut]
      -- ^ The transaction outputs, except for the output to the Marlowe validators.
      , meInterval :: Maybe TimeInterval
  ...
  | -- | A rollback.
    Rollback
      ...
      -- ^ The point to which the rollback occurred.
      , rollbackTip :: ChainTip
      -- ^ The tip when the rollback occurred.
      }
