...
lovelaceToPlutusAda :: C.Coin -> PA.Ada
lovelaceToPlutusAda (C.Coin v) = PA.Lovelace v

lovelaceToPlutusValue :: C.Coin -> P.Value
lovelaceToPlutusValue (C.Coin v) = P.singleton P.adaSymbol P.adaToken v
