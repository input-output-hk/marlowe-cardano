...
makeExample
  :: (MonadIO m)
  => FilePath
  -- ^ The output JSON file for the Marlowe contract.
  -> FilePath
  -- ^ The output JSON file for the Marlowe contract's state.
  -> (Contract, State)
  -- ^ The contract and state data.
  -> m ()
  -- ^ Action to serialise the Marlowe data.
