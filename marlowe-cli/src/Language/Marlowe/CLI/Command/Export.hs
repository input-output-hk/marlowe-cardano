...
module Language.Marlowe.CLI.Command.Export (
...
runExportCommand :: MonadError CliError m
                 => MonadIO m
                 => ExportCommand  -- ^ The command.
...
parseExportCommand :: O.Parser ExportCommand
parseExportCommand =
  O.hsubparser
...
exportMarloweCommand :: O.Mod O.CommandFields ExportCommand
exportMarloweCommand =
  O.command "marlowe"
...
exportMarloweOptions :: O.Parser ExportCommand
...
exportAddressCommand :: O.Mod O.CommandFields ExportCommand
exportAddressCommand =
  O.command "address"
...
exportAddressOptions :: O.Parser ExportCommand
...
exportValidatorCommand :: O.Mod O.CommandFields ExportCommand
exportValidatorCommand =
  O.command "validator"
...
exportValidatorOptions :: O.Parser ExportCommand
...
exportDatumCommand :: O.Mod O.CommandFields ExportCommand
exportDatumCommand =
  O.command "datum"
...
exportDatumOptions :: O.Parser ExportCommand
exportDatumOptions =
  ExportDatum
    <$> O.strOption                (O.long "contract-file" <> O.metavar "CONTRACT_FILE" <> O.help "JSON input file for the contract."      )
    <*> O.strOption                (O.long "state-file"    <> O.metavar "STATE_FILE"    <> O.help "JSON input file for the contract state.")
...
exportRedeemerCommand :: O.Mod O.CommandFields ExportCommand
exportRedeemerCommand =
  O.command "redeemer"
...
exportRedeemerOptions :: O.Parser ExportCommand
