...
data TemplateCommand =
    ...
    , minTime            :: POSIXTime -- ^ The minimum POSIX time.
...
templateTrivialOptions =
  TemplateTrivial
    ...
    <*> O.option parsePOSIXTime  (O.long "minimum-slot"        <> O.metavar "SLOT"          <> O.help "The minimum slot."                         )
    ...
    <*> O.option parsePOSIXTime  (O.long "timeout"             <> O.metavar "SLOT"          <> O.help "The timeout."                              )
...
templateEscrowOptions =
  TemplateEscrow
    ...
    <*> O.option parsePOSIXTime  (O.long "payment-deadline"   <> O.metavar "SLOT"          <> O.help "The deadline for the buyer to pay."                 )
    <*> O.option parsePOSIXTime  (O.long "complaint-deadline" <> O.metavar "SLOT"          <> O.help "The deadline for the buyer to complain."            )
    <*> O.option parsePOSIXTime  (O.long "dispute-deadline"   <> O.metavar "SLOT"          <> O.help "The deadline for the seller to dispute a complaint.")
    <*> O.option parsePOSIXTime  (O.long "mediation-deadline" <> O.metavar "SLOT"          <> O.help "The deadline for the mediator to decide."           )
    <*> O.strOption         (O.long "out-contract-file"  <> O.metavar "CONTRACT_FILE" <> O.help "JSON output file for the contract."                 )
    <*> O.strOption         (O.long "out-state-file"     <> O.metavar "STATE_FILE"    <> O.help "JSON output file for the contract's state."         )
...
templateSwapOptions =
  TemplateSwap
    ...
    <*> O.option parsePOSIXTime  (O.long "a-timeout"         <> O.metavar "SLOT"          <> O.help "The timeout for the first party's deposit."                     )
    ...
    <*> O.option parsePOSIXTime  (O.long "b-timeout"         <> O.metavar "SLOT"          <> O.help "The timeout for the second party's deposit."                    )
    <*> O.strOption         (O.long "out-contract-file" <> O.metavar "CONTRACT_FILE" <> O.help "JSON output file for the contract."                             )
    <*> O.strOption         (O.long "out-state-file"    <> O.metavar "STATE_FILE"    <> O.help "JSON output file for the contract's state."                     )
...
templateZeroCouponBondOptions =
  TemplateZeroCouponBond
    ...
    <*> O.option parsePOSIXTime  (O.long "lending-deadline"   <> O.metavar "POSIXTime"          <> O.help "The lending deadline."                                     )
    <*> O.option parsePOSIXTime  (O.long "repayment-deadline" <> O.metavar "POSIXTime"          <> O.help "The repayment deadline."                                   )
    <*> O.strOption         (O.long "out-contract-file"  <> O.metavar "CONTRACT_FILE" <> O.help "JSON output file for the contract."                        )
    <*> O.strOption         (O.long "out-state-file"     <> O.metavar "STATE_FILE"    <> O.help "JSON output file for the contract's state."                )
