...
runTemplateCommand TemplateTrivial{..}        = makeExample outputFile
                                                  $ makeTrivialContract
                                                      bystander
                                                      minAda
                                                      minSlot
                                                      ...
                                                      withdrawalLovelace
                                                      timeout
runTemplateCommand TemplateEscrow{..}         = makeExample outputFile
                                                  $ makeEscrowContract
                                                      minAda
                                                      price
                                                      seller
                                                      ...
                                                      disputeDeadline
                                                      mediationDeadline
runTemplateCommand TemplateSwap{..}           = makeExample outputFile
                                                  $ makeSwapContract
                                                      minAda
                                                      aParty
                                                      aToken
                                                      ...
                                                      bAmount
                                                      bTimeout
runTemplateCommand TemplateZeroCouponBond{..} = makeExample outputFile
                                                  $ makeZeroCouponBond
                                                      minAda
                                                      lender
                                                      borrower
