...
tools pre-installed. Use the \"Open a Marlowe terminal\" menu item in
the \"Daedalus\" menu. This feature is not available in Marlowe Daedalus
for Windows.
...
signing keys for the first address in the wallet. In this example,
let\'s assume that the seed phrase for the wallet is stored in a file
name `my-wallet.seed`. (The seed phrase could have been generated by
