...
import           Language.Marlowe.SemanticsTypes                       (Observation, Value)

stateTransition :: EventType -> RiskFactorsMarlowe -> LocalTime -> LocalTime -> ContractStateMarlowe -> Reader (CtxSTF Double) ContractStateMarlowe
stateTransition ev rf prevDate t st = reader stateTransitionFs'
  where
    stateTransitionFs' CtxSTF{ contractTerms = ct'@ContractTermsPoly {maturityDate = md, dayCountConvention = Just dcc, cycleAnchorDateOfInterestPayment = Just ipanx}, ..} =
        stf ev (toMarlowe ct')
        where
          stf :: EventType -> ContractTermsPoly (Value Observation) -> ContractStatePoly (Value Observation)
          stf AD _ = _STF_AD_PAM st t y_sd_t
          stf IED ct@ContractTermsPoly {contractType = PAM} = _STF_IED_PAM ct st t y_ipanx_t
          stf IED ct@ContractTermsPoly {contractType = LAM} = _STF_IED_LAM ct st t y_ipanx_t
          stf IED ct@ContractTermsPoly {contractType = NAM} = _STF_IED_LAM ct st t y_ipanx_t
          stf IED ct@ContractTermsPoly {contractType = ANN} = _STF_IED_LAM ct st t y_ipanx_t
          stf PR ct@ContractTermsPoly {contractType = LAM} = _STF_PR_LAM ct st t y_sd_t
          stf PR ct@ContractTermsPoly {contractType = NAM} = _STF_PR_NAM ct st t y_sd_t
          stf PR ct@ContractTermsPoly {contractType = ANN} = _STF_PR_NAM ct st t y_sd_t
          stf MD ContractTermsPoly {contractType = PAM} = _STF_MD_PAM st t
          stf MD ContractTermsPoly {contractType = LAM} = _STF_MD_LAM st t
          stf MD ContractTermsPoly {contractType = NAM} = _STF_MD_LAM st t
          stf MD ContractTermsPoly {contractType = ANN} = _STF_MD_LAM st t
          stf PP ct@ContractTermsPoly {contractType = PAM} = _STF_PP_PAM ct st rf t y_sd_t y_tfpminus_t y_tfpminus_tfpplus
          stf PP ct@ContractTermsPoly {contractType = LAM} = _STF_PP_LAM ct st rf t y_sd_t y_tfpminus_t y_tfpminus_tfpplus
          stf PP ct@ContractTermsPoly {contractType = NAM} = _STF_PP_LAM ct st rf t y_sd_t y_tfpminus_t y_tfpminus_tfpplus
          stf PP ct@ContractTermsPoly {contractType = ANN} = _STF_PP_LAM ct st rf t y_sd_t y_tfpminus_t y_tfpminus_tfpplus
          stf PY ct@ContractTermsPoly {contractType = PAM} = _STF_PY_PAM ct st t y_sd_t y_tfpminus_t y_tfpminus_tfpplus
          stf PY ct@ContractTermsPoly {contractType = LAM} = _STF_PY_LAM ct st t y_sd_t y_tfpminus_t y_tfpminus_tfpplus
          stf PY ct@ContractTermsPoly {contractType = NAM} = _STF_PY_LAM ct st t y_sd_t y_tfpminus_t y_tfpminus_tfpplus
          stf PY ct@ContractTermsPoly {contractType = ANN} = _STF_PY_LAM ct st t y_sd_t y_tfpminus_t y_tfpminus_tfpplus
          ...
          stf PRD ct@ContractTermsPoly {contractType = PAM} = _STF_PRD_PAM ct st t y_sd_t y_tfpminus_t y_tfpminus_tfpplus
          stf PRD ct@ContractTermsPoly {contractType = LAM} = _STF_PRD_LAM ct st t y_sd_t y_tfpminus_t y_tfpminus_tfpplus
          stf PRD ct@ContractTermsPoly {contractType = NAM} = _STF_PRD_LAM ct st t y_sd_t y_tfpminus_t y_tfpminus_tfpplus
          stf PRD ct@ContractTermsPoly {contractType = ANN} = _STF_PRD_LAM ct st t y_sd_t y_tfpminus_t y_tfpminus_tfpplus
          stf TD _ = _STF_TD_PAM st t
          stf IP ct = _STF_IP_PAM ct st t y_sd_t
          stf IPCI ct@ContractTermsPoly {contractType = PAM} = _STF_IPCI_PAM ct st t y_sd_t
          stf IPCI ct@ContractTermsPoly {contractType = LAM} = _STF_IPCI_LAM ct st t y_sd_t
          stf IPCI ct@ContractTermsPoly {contractType = NAM} = _STF_IPCI_LAM ct st t y_sd_t
          stf IPCI ct@ContractTermsPoly {contractType = ANN} = _STF_IPCI_LAM ct st t y_sd_t
          stf IPCB ct@ContractTermsPoly {contractType = LAM} = _STF_IPCB_LAM ct st t y_sd_t y_tfpminus_t y_tfpminus_tfpplus
          stf IPCB ct@ContractTermsPoly {contractType = NAM} = _STF_IPCB_LAM ct st t y_sd_t y_tfpminus_t y_tfpminus_tfpplus
          stf IPCB ct@ContractTermsPoly {contractType = ANN} = _STF_IPCB_LAM ct st t y_sd_t y_tfpminus_t y_tfpminus_tfpplus
          stf RR ct@ContractTermsPoly {contractType = PAM} = _STF_RR_PAM ct st rf t y_sd_t y_tfpminus_t y_tfpminus_tfpplus
          stf RR ct@ContractTermsPoly {contractType = LAM} = _STF_RR_LAM ct st rf t y_sd_t y_tfpminus_t y_tfpminus_tfpplus
          stf RR ct@ContractTermsPoly {contractType = NAM} = _STF_RR_LAM ct st rf t y_sd_t y_tfpminus_t y_tfpminus_tfpplus
          stf RR ct@ContractTermsPoly {contractType = ANN} = _STF_RR_ANN ct st rf t y_sd_t y_tfpminus_t y_tfpminus_tfpplus ti
          stf RRF ct@ContractTermsPoly {contractType = PAM} = _STF_RRF_PAM ct st t y_sd_t y_tfpminus_t y_tfpminus_tfpplus
          stf RRF ct@ContractTermsPoly {contractType = LAM} = _STF_RRF_LAM ct st t y_sd_t y_tfpminus_t y_tfpminus_tfpplus
          stf RRF ct@ContractTermsPoly {contractType = NAM} = _STF_RRF_LAM ct st t y_sd_t y_tfpminus_t y_tfpminus_tfpplus
          stf RRF ct@ContractTermsPoly {contractType = ANN} = _STF_RRF_ANN ct st t y_sd_t y_tfpminus_t y_tfpminus_tfpplus ti
          stf SC ct@ContractTermsPoly {contractType = PAM} = _STF_SC_PAM ct st rf t y_sd_t y_tfpminus_t y_tfpminus_tfpplus
          stf PRF ct@ContractTermsPoly {contractType = ANN} = _STF_PRF_ANN ct st t y_sd_t y_tfpminus_t y_tfpminus_tfpplus y_t ti
          stf CE ContractTermsPoly {contractType = PAM} = _STF_CE_PAM st t y_sd_t
          stf SC ct@ContractTermsPoly {contractType = LAM} = _STF_SC_LAM ct st rf t y_sd_t y_tfpminus_t y_tfpminus_tfpplus
          stf CE ContractTermsPoly {contractType = LAM} = _STF_CE_PAM st t y_sd_t
          stf SC ct@ContractTermsPoly {contractType = NAM} = _STF_SC_LAM ct st rf t y_sd_t y_tfpminus_t y_tfpminus_tfpplus
          stf SC ct@ContractTermsPoly {contractType = ANN} = _STF_SC_LAM ct st rf t y_sd_t y_tfpminus_t y_tfpminus_tfpplus
          stf XD ct@ContractTermsPoly {contractType = OPTNS} = _STF_XD_OPTNS ct st rf t
          stf XD ct@ContractTermsPoly {contractType = FUTUR} = _STF_XD_FUTUR ct st rf t
          stf CE _ = _STF_AD_PAM st t y_sd_t
          stf _ _ = st
