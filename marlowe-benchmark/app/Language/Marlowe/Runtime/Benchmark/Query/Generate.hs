...
roleCurrencies =
  S.fromList
    [ -- Frequent roles currencies on `mainnet`.
    ...
    , -- Frequent roles currencies on `preprod`.
    ...
    , -- Frequent roles currencies on `preview`.
...
tags =
  S.fromList
    [ -- Frequent tags on `mainnet`.
      "run-lite"
    , -- Frequent tags on `preprod`.
      "5july2023"
    , "run-lite"
...
contractIds =
  S.fromList
    [ -- Contracts with many transactions on `mainnet`.
    ...
    , -- Contracts with many transactions on `preprod`.
    ...
    , -- Contracts with many transactions on `preview`.
...
withdrawalTxIds =
  S.fromList
    [ -- Withdrawal transactions with many payouts on `mainnet`.
    ...
    , -- Withdrawal transactions with many payouts on `preprod`.
    ...
    , -- Withdrawal transactions with many payouts on `preview`.
