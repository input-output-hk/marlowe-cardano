...
recordEndPrice name choiceId1 choiceId2 = Let name (DivValue (MulValue priceBeginning (MulValue (ChoiceValue choiceId1) (ChoiceValue choiceId2))) (Constant ((fromInt 100000000) * (fromInt 100000000))))
