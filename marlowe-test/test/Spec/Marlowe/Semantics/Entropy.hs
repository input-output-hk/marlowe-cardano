...
checkEntropy
  ...
  -> (Double, Double)
  -- ^ The valid rand for the entropy.
  -> Gen a
...
tests =
  testGroup
    ...
    [ testGroup
        "Entropy"
        [ testCase "PubKeyHash" $
            checkEntropy 1000 (logBase 2 5, logBase 2 100) (arbitrary :: Gen PubKeyHash)
        , testCase "CurrencySymbol" $
            checkEntropy 1000 (logBase 2 5, logBase 2 100) (arbitrary :: Gen CurrencySymbol)
        , testCase "TokenName" $
            checkEntropy 1000 (logBase 2 5, logBase 2 100) (arbitrary :: Gen TokenName)
        , testCase "Token" $
            checkEntropy 1000 (logBase 2 5, logBase 2 100) (arbitrary :: Gen Token)
        , testCase "Party" $
            checkEntropy 1000 (logBase 2 5, logBase 2 100) (arbitrary :: Gen Party)
        , testCase "ChoiceName" $ checkEntropy 1000 (logBase 2 5, logBase 2 100) arbitraryChoiceName
        , testCase "ChoiceId" $
            checkEntropy 1000 (logBase 2 5, logBase 2 100) (arbitrary :: Gen ChoiceId)
        , testCase "ValueId" $
            checkEntropy 1000 (logBase 2 5, logBase 2 100) (arbitrary :: Gen ValueId)
        , testCase "accounts" $
            checkEntropy 1000 (logBase 2 5, logBase 2 1000) (AM.keys <$> (arbitrary :: Gen Accounts))
        , testCase "choices" $
            checkEntropy 1000 (logBase 2 5, logBase 2 1000) (AM.keys <$> (arbitrary :: Gen (AM.Map ChoiceId ChosenNum)))
        , testCase "boundValues" $
            checkEntropy 1000 (logBase 2 5, logBase 2 1000) (AM.keys <$> (arbitrary :: Gen (AM.Map ValueId Integer)))
        ]
    ]
