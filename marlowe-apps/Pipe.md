...
See `CreateStep` and `ContractStep` in [`Language.Marlowe.Runtime.History.Api`](../marlowe-runtime/sync-api/Language/Marlowe/Runtime/History/Api.hs) for details on the contents of the `creation` and `steps` fields.
